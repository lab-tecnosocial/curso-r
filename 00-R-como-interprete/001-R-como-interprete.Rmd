...
- Posit RStudio, que es el editor de código: https://posit.co/download/rstudio-desktop/

> Nota: En 2022 RStudio cambió de nombre a **Posit RStudio**. Si buscas tutoriales o documentación antigua verás el nombre "RStudio" — es el mismo programa.
...
Siempre que trabajemos con R es clave que creemos "Proyectos" en Posit RStudio:
...
- Una vez creado el proyecto, el punto de partida es crear tu primer archivo de R. Para ello: File > New File > R Script
