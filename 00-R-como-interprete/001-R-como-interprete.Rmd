...
R es un sistema para la estadística computacional. Pero es mejor entenderlo tanto como un lenguaje de programación y un interprete que traduce ese lenguaje a operaciones computacionales útiles sobre datos.

![](../pizarras/drawings/comunicacion-con-R.png)
Es decir que para comunicarte con R debes usar un "código" en R.
...
Las expresiones son una combinación compleja de declaraciones, funciones, variables y datos que se evaluan o reducen a un valor usable, por ejemplo:
```{r, eval = F}
...
Normalmente escribiras muchas expresiones, declaraciones, funciones y variables combinadas en un solo archivo, que será una especie de "guión" (script) que R deberá ejecutar, paso a paso. Estos archivos normalmente se ejecutan de arriba hacía abajo secuencialmente, por ejemplo:
